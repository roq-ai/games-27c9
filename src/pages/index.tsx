  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Games - Unleash your strategic skills in our maze game, where infinite possibilities await at every turn."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1634471887351-8bed1dbf37b3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtYXplJTJDZ2FtZXxlbnwwfHx8fDE2ODk3OTYxNjd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@marinareich?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Marina Reich`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Games - Unleash your strategic skills in our maze game, where infinite possibilities await at every turn.`}
            </Text>
            <Box
